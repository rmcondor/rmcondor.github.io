...
<br/><img src='/images/metodologia_header.jpeg'>
...
[^1]: Historically, the empirical sciences have imported methodological structures from the natural sciences. In an even more extreme movement, some fundamental economic concepts owe their origin to classical mechanics. In 1871, Jevons maintained that "[economic] theory (...) presents a strong analogy with the science of static mechanics, and the laws of exchange are found to resemble the laws of equilibrium of a lever as determined by the principle of virtual velocities" (Jevons, 1998 [1871]).

[^2]: For example, the so-called bioeconomic approach, or ecological economics, holds that the economic process is merely an extension of the biological process, and that the most important economic considerations must therefore be viewed from a new perspective (Georgescu-Roegen, 2007).

[^3]: In the second part of the article, some methodological operations that have only been mentioned here — such as abstraction, causal relationships, and empirical testing — will be developed in greater detail. For this purpose, the Alpha-Beta method will be employed.

[^4]: According to Figueroa (2008), the theory of the individual (whether consumer or producer) does not attempt to explain the particular behavior of a single individual, but rather the behavior of the group. To this end, the assumption is made that all members of the group behave in the same way as an abstract individual representative of the interests and motivations of the group under study.
